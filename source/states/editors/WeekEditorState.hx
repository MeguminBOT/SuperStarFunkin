...
class WeekEditorState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	override function create() {
		...
		txtWeekTitle.setFormat("orbitron.ttf", 32, FlxColor.WHITE, RIGHT);
		...
		missingFileText.setFormat(Paths.font("orbitron.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		txtTracklist.font = Paths.font("orbitron.ttf");
