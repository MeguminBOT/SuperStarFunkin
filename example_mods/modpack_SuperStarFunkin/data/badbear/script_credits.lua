function onCreatePost()
	makeLuaText('header', 'Badbear:', 600, 1450, 425)
	...
	setTextString('credits', 'FrozenBlueberry - Sprites/BG\nPouria_SFMs - BF Sprite\nSpringy - Song, Charting (Hard)\nZombie07King - Icons, Chromatics\nAutisticLulu - Coding, Audio Mix, Charting (Ruined)')
